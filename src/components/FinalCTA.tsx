        ...
        <div className="bg-brand-card border border-brand-border/50 p-10 md:p-16 rounded-[3rem] relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h2 className="text-3xl md:text-5xl font-bold mb-6">
              Entre no ecossistema e acompanhe tudo sendo criado na prática.
            </h2>
            <p className="text-brand-muted text-lg md:text-xl max-w-2xl mx-auto mb-10">
              A comunidade é onde eu compartilho bastidores, prompts, aulas, ferramentas, 
              atualizações e processos reais enquanto construo e vendo esses produtos.
            </p>
